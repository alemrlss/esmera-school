...
function Footer() {
  return (
    <footer>
      <div className="d-footer bg-base-200 text-base-content p-10 flex flex-col items-center lg:flex-row lg:justify-between">
        {/* Contenido Principal */}
      ...
      <div className="w-full bg-base-200 py-4 text-center text-sm text-gray-500 px-4 md:px-0">
        <p>
          &copy; {new Date().getFullYear()} Esmera School. Todos los derechos
          reservados.
        </p>
