...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const [theme, setTheme] = useState<Theme>(() => {
    // Cargar el tema del localStorage o el sistema operativo
  ...
  useEffect(() => {
    document.getElementById("root")?.setAttribute("data-theme", theme); // Asignar tema a DaisyUI
...
// Ejemplo de componente de botón para cambiar el tema
